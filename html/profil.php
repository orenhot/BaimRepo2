        ...
        <div class="content-wrapper container-xxl p-0">
            <div class="content-body">
                ...
                <section id="knowledge-base-search">
                    <div class="row">
                        <div class="col-12">
                            <div class="card knowledge-base-bg text-center" style="background-image: url('../app-assets/images/banner/banner.png')" style="margin-bottom: 5%;">
                                <div class="card-body">
                            ...
                            <div class="card">
                                <a href="page-kb-category.html">
                                    ...
                                    <div class="card-body text-center">
                                        <h4>PT. Soman Indonesia</h4>
                                        <p class="text-body mt-1 mb-0">
                                            deskripsi...
                                        </p><br>
                                        <a href="profil-detail.php" class="btn btn-primary">view</a>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-12 kb-search-content">
                            <div class="card">
                                <a href="page-kb-category.html">
                                    ...
                                    <div class="card-body text-center">
                                        <h4>PT. Indorama Indonesia</h4>
                                        <p class="text-body mt-1 mb-0">deksripsi..</p><br>
                                        <a href="profil-detail.php" class="btn btn-primary">view</a>
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="col-md-4 col-sm-6 col-12 kb-search-content">
                            <div class="card">
                                <a href="page-kb-category.html">
                                    ...
                                    <div class="card-body text-center">
                                        <h4>Sampoerna HM Tbk</h4>
                                        <p class="text-body mt-1 mb-0">deskripsi..</p><br>
                                        <a href="profil-detail.php" class="btn btn-primary">view</a>
                                    </div>
                                </a>
                            </div>
