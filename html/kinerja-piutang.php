            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="file-text"></i><span class="menu-title text-truncate" data-i18n="Invoice">Laporan</span></a>
                    <ul class="menu-content">
                        <li class="active"><a class="d-flex align-items-center" href="kinerja-piutang.php"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="List">Kinerja Piutang</span></a>
                        </li>
                ...
                <section id="dashboard-ecommerce">
                        ...
                        <div class="col-lg-7 col-md-6 col-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h4 class="card-title">Performa Piutang</h4>
                                </div><br>
                                <div class="card-body">
                                            ...
                                            <div class="transaction-item">
                                                <div class="d-flex">
                                                    <div class="transaction-percentage">
                                                        <h4 class="transaction-title">Jumlah Saldo</h2><br>
                                                ...
                                                <div class="d-flex">
                                                    <div class="transaction-percentage">
                                                        <h4 class="transaction-title">Belum Terbayar</h2><br>
                                                        <h2 class="transaction-title">Rp. 200.768.990</h2>
                                                    </div>
                                                </div>
                                                <div class="d-flex">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Sampoerna HM Tbk</td>
                                                <td>
                                                    <p class="mb-50">45%</p>
                                                    <div class="progress progress-bar-success" style="height: 6px">
                                                        <div class="progress-bar" role="progressbar" aria-valuenow="50" aria-valuemin="50" aria-valuemax="100" style="width: 45%"></div>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
                    ...
                    <div class="row match-height">
                        ...
                        <div class="col-lg-7 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Mitra Transaksi Tertinggi</h4>
                                    <button type="button" class="btn btn-primary btn-sm">view all</button>
                                </div>
                                <div class="card card-transaction">
                                    <div class="col-12">
                        ...
                        <div class="col-lg-5 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Top Mitra</h4>
                                    <h6>Mei 2022 - April 2022</h6>
                                </div>
                                <div class="card card-transaction">
                                    <div class="col-12">
                                        <div class="card-body">
