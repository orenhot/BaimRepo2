    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="nav-item"><a class="d-flex align-items-center" href="mydashboard.php"><i data-feather="monitor"></i><span class="menu-title text-truncate" data-i18n="Email">Dashboard Saya</span></a>
                </li>
                ...
                <li class="active"><a class="d-flex align-items-center" href="create-user.php"><i data-feather="user-plus"></i><span class="menu-title text-truncate" data-i18n="Chat">Create Akun Mitra</span></a>
                </li>
                    ...
                    <div class="modal-dialog sidebar-sm">
                        <form class="add-new-record modal-content pt-0">
                            ...
                            <div class="modal-body flex-grow-1">
                                <div class="mb-1">
                                    <label class="form-label" for="basic-icon-default-fullname">ID Mitra / No. PKS</label>
                                    <input type="text" class="form-control dt-full-name" id="basic-icon-default-fullname" placeholder="Masukan ID Mitra atau No. PKS.." /><br>
                                    <button type="button" class="btn btn-primary btn-sm"><i data-feather="search"></i> Periksa Mitra</button>
                                </div>
                                <hr>
                                <div class="mb-1">
                                    <label class="form-label" for="basic-icon-default-fullname">Nama Mitra</label>
                                    <input type="text" class="form-control dt-full-name" id="basic-icon-default-fullname" readonly disabled/>
                                </div>
                                <div class="mb-1">
                                    <label class="form-label" for="basic-icon-default-fullname">PIC</label>
                                    <input type="text" class="form-control dt-full-name" id="basic-icon-default-fullname" readonly disabled/>
                                </div>
                                <div class="mb-1">
                                    <label class="form-label" for="basic-icon-default-post">Alamat</label>
                                    <input type="text" id="basic-icon-default-post" class="form-control dt-post" readonly disabled/>
                                </div>
                                <div class="mb-1">
                                    <label class="form-label" for="basic-icon-default-email">Kontak</label>
                                    <input type="text" id="basic-icon-default-email" class="form-control dt-email" readonly disabled/>
                                </div>
                                <div class="mb-1">
                                ...
                                <div class="mb-1">
                                    <label class="form-label" for="basic-icon-default-email">Jenis Bisnis</label>
                                    <input type="text" id="basic-icon-default-email" class="form-control dt-email" readonly disabled/>
                                </div>
