    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="user"></i><span class="menu-title text-truncate" data-i18n="Chat">Create Akun Mitra</span></a>
                </li>
                                    ...
                                    <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
                                        <div>
                                            <div class="logo-wrapper">
                                                <img src="../app-assets/images/posindo.png" width="100">
                                            </div>
                                            <p class="card-text mb-25">Graha Pos Indonesia</p>
                                            <p class="card-text mb-25">Jalan Banda No. 30, Citarum</p>
                                            <p class="card-text mb-25">Kecamatan Bandung Wetan, 40115, Bandung</p>
                                            <p class="card-text mb-0">+62 (123) 456 7891, +62 (876) 543 2198</p>
                                        </div>
                                        <div class="mt-md-0 mt-2">
                                            ...
                                            <div class="invoice-date-wrapper">
                                                ...
                                                <p class="invoice-date">01/05/2022</p>
                                            </div>
                                            <div class="invoice-date-wrapper">
                                                <p class="invoice-date-title">Due Date:</p>
                                                <p class="invoice-date">04/05/2022</p>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Header ends -->
                                ...
                                <div class="card-body invoice-padding pt-0">
                                    <div class="row invoice-spacing">
                                        <div class="col-xl-8 p-0">
                                            ...
                                            <p class="card-text mb-25">PT> Telkom Indonesia</p>
                                            <p class="card-text mb-25">Small Heath, B10 0HF, INA</p>
                                            ...
                                            <table>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><span class="fw-bold">Rp.12.110.550</span></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td class="pe-1">Negara:</td>
                                                        <td>Indonesia</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="pe-1">Virtual Account:</td>
                                                        <td>95476213874685</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="py-1">
                                                    <span class="fw-bold">Rp. 1.800.000</span>
                                                </td>
                                            </tr>
                                        ...
                                        <div class="col-md-6 d-flex justify-content-end order-md-2 order-1">
                                            <div class="invoice-total-wrapper">
                                                <div class="invoice-total-item">
                                                    ...
                                                    <p class="invoice-total-amount">Rp. 4.200.000</p>
                                                </div>
                                                <div class="invoice-total-item">
                                                ...
                                                <div class="invoice-total-item">
                                                    ...
                                                    <p class="invoice-total-amount">11%</p>
                                                </div>
                                                <hr class="my-50" />
                                                <div class="invoice-total-item">
                                                    <p class="invoice-total-title">Total:</p>
                                                    <p class="invoice-total-amount">Rp. 4.662.000</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body invoice-padding pt-0">
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <span>Detail transaksi dapat anda lihat di website PosBill - <a href="https://posbill.posindonesia.co.id">https://posbill.posindonesia.co.id</a>. Terima Kasih!</span>
                                        </div>
                                    </div>
                                </div>
                                <!-- Invoice Note ends -->
                            ...
                            <div class="modal-body flex-grow-1">
                                <form>
                                    <div class="mb-1">
                                        ...
                                        <input type="text" class="form-control" id="invoice-from" value="posbill@posindonesia.co.id.com" placeholder="company@email.com" />
                                    </div>
                                    <div class="mb-1">
                                        <label for="invoice-to" class="form-label">To</label>
                                        <input type="text" class="form-control" id="invoice-to" value="telkom@mail.com" placeholder="company@email.com" />
                                    </div>
                                    <div class="mb-1">
                                        <label for="invoice-subject" class="form-label">Subject</label>
                                        <input type="text" class="form-control" id="invoice-subject" value="Tagihan PosBill" placeholder="Invoice regarding goods" />
                                    </div>
                                    <div class="mb-1">
