            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="file-text"></i><span class="menu-title text-truncate" data-i18n="Invoice">Laporan</span></a>
                    <ul class="menu-content">
                        ...
                        <li class="active"><a class="d-flex align-items-center" href="mitra-macet.php"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Preview">Invoice Jatuh Tempo</span></a>
                        </li>
                                        ...
                                        <div data-repeater-item>
                                            <div class="row d-flex align-items-end">
                                                <div class="col-md-2 col-12">
                                                    <div class="mb-1">
                                                        <label class="form-label" for="itemcost">REGIONAL</label>
                                                        <select class="select2 form-select" id="select2-basic">
                                                            <option value="SR">Semua Regional</option>
                                                            <option value="AK">Regional 1</option>
                                                            <option value="HI">Regional 2</option>
                                                            <option value="CA">Regional 3</option>
                                                            <option value="NV">Regional 4</option>
                                                            <option value="OR">Regional 5</option>
                                                            <option value="WA">Regional 6</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3 col-12">
                                                    <div class="mb-1">
                                                        <label class="form-label" for="itemcost">KCU / KC</label>
                                                        <select class="select2 form-select" id="select2-basic1">
                                                            <option value="SR">Semua Kantor</option>
                                                            <option value="AK">KCU Bandung 40000</option>
                                                            <option value="HI">KC Cimahi 40500</option>
                                                            <option value="CA">KC Soreang 40900</option>
                                                            <option value="NV">KC Ujungberung 40300</option>
                                                            <option value="OR">KC Banjar 40600</option>
                                                            <option value="WA">KC Garut 40700</option>
                                                        </select>
                                                    </div>
                                                </div>
